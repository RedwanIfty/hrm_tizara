    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                @endif
                <li class="menu-title"> <span>Employee Information</span> </li>
                <li class="{{set_active(['education/list','education/add'])}} submenu">
                    <a href="#" class="{{ set_active(['education/list','education/add']) ? 'noti-dot' : '' }}">
                        <i class="la la-graduation-cap"></i> <span> All Information</span> <span class="menu-arrow"></span>
                    </a>
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
